...
map <Figure_type, Point> shift;                 ///Сдвиг фигуры влево и вниз до ближайшего узла сетки
...
void build () {
    ...
    //==============================================================================================================================================================
    //{
    shift[LINE] = {BLOCK_SIZE, 0};
    shift[L_SHAPED1] = {BLOCK_SIZE / 2, BLOCK_SIZE / 2};
    shift[L_SHAPED2] = {BLOCK_SIZE / 2, BLOCK_SIZE / 2};
    shift[SQUARE] = {0, 0};
    shift[Z_SHAPED1] = {BLOCK_SIZE / 2, BLOCK_SIZE / 2};
    shift[Z_SHAPED2] = {BLOCK_SIZE / 2, BLOCK_SIZE / 2};
    shift[T_SHAPED] = {BLOCK_SIZE / 2, BLOCK_SIZE / 2};
    shift[NOT_FIGURE] = {0, 0};
    //}
    //==============================================================================================================================================================
    ...
    start_pos[NOT_FIGURE] = {(900 - X_LEFT) / 36, (396 - Y_UP) / 36};
    //==============================================================================================================================================================
    //}
